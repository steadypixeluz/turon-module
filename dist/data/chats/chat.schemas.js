...
], ModelChat.prototype, "entity_id", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: String,
        required: true,
...
exports.ModelChat = ModelChat = __decorate([
    (0, mongoose_1.Schema)({ collection: 'chats', timestamps: true })
], ModelChat);
exports.ModelChatSchema = mongoose_1.SchemaFactory.createForClass(ModelChat);
exports.ModelChatSchema.index({ entity_id: 1, sellerId: 1, buyerId: 1 }, { unique: true });
