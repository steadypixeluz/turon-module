...
export const CLIENT_WITH_PHONE_NUMBER_NOT_FOUND = {
...
export const CLIENT_ALREADY_REGISTERED_PHONE_NUMBER = {
...
export const CLIENT_ALREADY_REGISTERED_EMAIL = {
...
export const CLIENT_ALREADY_REGISTERED = {
