...
export class ModelCustomerCompany {
  ...
  @Prop({ type: 'string', enum: CustomerCompanyStatus, default: CustomerCompanyStatus.new })
  status: string;
...
export const ModelCustomerCompanySchema = SchemaFactory.createForClass(ModelCustomerCompany);
